...
if ( ! class_exists( 'OptionsBuddy_Settings_Page' ) ):
	...
	class OptionsBuddy_Settings_Page {
		 ...
		 * Callbacks.
		 *
		 * @var array [field=>callback,field=>callback,....]
		 */
		private $cb_stack = array();
		...
		/**
		 * Flag to indicate if we are in network mode
		 *
		 * @var bool
		 */
		...
		/**
		 * Flag to indicate if we are in BuddyPress mode
		 *
		 * @var bool
		 */
		...
		/**
		 * Checks if using the single option.
		 *
		 * @return $this
		 */
		...
		/**
		 * Checks if we are using unique option.
		 *
		 * @return bool
		 */
		...
		/**
		 * Checks if network mode is enabled.
		 *
		 * @return bool
		 */
		...
		/**
		 * Sets BuddyPress mode for options.
		 *
		 * @return $this
		 */
		...
		/**
		 * Checks if BuddyPress mode is enabled.
		 *
		 * @return bool
		 */
		...
		/**
		 * Sets an option name if you want. It is only used if using_unique_option is disabled
		 *
		 ...
		 * Sets option group.
		 *
		 * @param string $optgroup opt group.
		 */
